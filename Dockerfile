...
ARG VITE_SITEFORGE_DEVELOPMENT_ORIGIN
ARG VITE_SITEFORGE_DEVELOPMENT_COMPATIBILITY_ORIGINS
ENV VITE_SUPABASE_URL=$VITE_SUPABASE_URL \
    VITE_SUPABASE_PUBLISHABLE_KEY=$VITE_SUPABASE_PUBLISHABLE_KEY \
    VITE_SITEFORGE_PREVIEW_ORIGIN=$VITE_SITEFORGE_PREVIEW_ORIGIN \
    VITE_SITEFORGE_DEVELOPMENT_ORIGIN=$VITE_SITEFORGE_DEVELOPMENT_ORIGIN \
    VITE_SITEFORGE_DEVELOPMENT_COMPATIBILITY_ORIGINS=$VITE_SITEFORGE_DEVELOPMENT_COMPATIBILITY_ORIGINS \
