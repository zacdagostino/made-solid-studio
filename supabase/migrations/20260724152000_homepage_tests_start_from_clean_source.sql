-- A homepage test is only a revision when a caller explicitly supplies a
-- completed private source run. Never inherit a prior homepage checkpoint for
-- the Create page from scratch path.
