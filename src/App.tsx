    ...
    selectedAgentPackage?.status === 'test_ready'
      ? [
          ...
          },
          {
            ...
            revision: `v${selectedAgentPackage.version}.68`,
            change:
              'Latest edit: Workspace now loads each client’s live CSS, JavaScript, images, navigation, and HMR through a short-lived signed Preview path while the client frame stays opaque, cookie-free, and isolated from every other client.',
          },
          {
