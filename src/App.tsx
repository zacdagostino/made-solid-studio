    ...
    selectedAgentPackage?.status === 'test_ready'
      ? [
          ...
          },
          {
            ...
            revision: `v${selectedAgentPackage.version}.86`,
            change:
              'Latest edit: authenticated Codex branches now allow longer fork operations to finish; if a response is interrupted, Studio directs the reviewer to check Conversations and retry only when the new branch is absent, without claiming success.',
          },
          {
