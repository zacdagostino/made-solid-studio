    ...
    selectedAgentPackage?.status === 'test_ready'
      ? [
          ...
          },
          {
            ...
            revision: `v${selectedAgentPackage.version}.57`,
            change:
              'Latest edit: the permanent Studio address now serves the persistent editable source, so reviewed changes remain visible immediately after Railway restarts instead of reverting to an older image snapshot.',
          },
          {
